...
The goal is not to make money. The capital involved ($500–1000 per live account) is financially irrelevant. The real goals:
...
- Shadow-to-live graduation is the only path that grows the number of live accounts (see D5a). The system never opens an account or deposits capital on its own.
...
One-time/capital items (not part of the monthly figure): both live accounts each get $500–1000 in funding (total $1000–2000), risk capital, funded only in the live phase, fully at risk of loss. Every shadow-to-live graduation adds one more account's worth of funding, same range, individually approved by hand — there's no cap on the eventual number of accounts, only on how fast new ones get approved.
